...
CREATE SEQUENCE CAR_SEQ
        INCREMENT BY 1 MAXVALUE 5000 CYCLE;
EXECUTE INSERTCAR('Truck',1985,'blue',1500.45);
EXECUTE INSERTCAR('Car',2010,'white',10000.22);
EXECUTE INSERTCAR('SUV',2014,'grey',15000.22);
...
EXECUTE INSERTOFFER(2,1,100.25,76); 
